...
class Business(models.Model):
    ...
    messenger    = tinymce_models.HTMLField(verbose_name='Facebook Messenger', blank=True, null=True)
    pixel        = tinymce_models.HTMLField(verbose_name='Facebook Pixel', blank=True, null=True)
    analytics    = tinymce_models.HTMLField(verbose_name='Google Analytics', blank=True, null=True)
    analytics2   = tinymce_models.HTMLField(verbose_name='Analytics 2', blank=True, null=True)
